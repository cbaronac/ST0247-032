...
public class Reader {
     ...
     * @return
     */
    public static HashMap<Long, Pair<Vertex, LinkedList<Edge>>> makeMap() {
    ...
    public static ArrayList<Long> getSuccessors(HashMap<Long, Pair<Vertex, LinkedList<Edge>>> grafo, int verticeID){
    ...
    public static double getWeight(HashMap<Long, Pair<Vertex, LinkedList<Edge>>> grafo,int inicioID, int destinoID){
